...
public class CommentController {
    ...
    @ApiOperation("发布评论")
    @PostMapping("/publish/{rootId}")
    public Result<Object> publish(@PathVariable("rootId") Long rootId, @RequestBody CommentDTO commentDTO) {
        commentService.commentPublish(rootId, commentDTO);
