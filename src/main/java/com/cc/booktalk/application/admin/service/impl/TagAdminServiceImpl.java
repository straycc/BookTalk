...
import com.cc.booktalk.entity.result.TagUpResult;
import com.cc.booktalk.entity.dto.tag.PageTagDTO;
import com.cc.booktalk.entity.dto.tag.TagDTO;
import com.cc.booktalk.entity.entity.category.Category;
import com.cc.booktalk.entity.entity.tag.BookTagRelation;
import com.cc.booktalk.entity.entity.tag.Tag;
import com.cc.booktalk.entity.entity.tag.TagES;
import com.cc.booktalk.entity.vo.TagVO;
import com.cc.booktalk.infrastructure.persistence.admin.mapper.BookTagAdminMapper;
import com.cc.booktalk.infrastructure.persistence.admin.mapper.CategoryAdminMapper;
import com.cc.booktalk.infrastructure.persistence.admin.mapper.TagAdminMapper;
import com.cc.booktalk.application.admin.service.TagAdminService;
...
public class TagAdminServiceImpl extends ServiceImpl<TagAdminMapper, Tag> implements TagAdminService {
    ...
    public TagVO getDetail(Long id) {
        ...
        //获取分类名
        Category category = categoryAdminMapper.selectById(tag.getCategoryId());
        if(category != null){
