...
import com.cc.booktalk.entity.result.UploadResult;
import com.cc.booktalk.entity.dto.book.BookDTO;
...
import com.cc.booktalk.entity.entity.book.BookES;
...
import com.cc.booktalk.application.admin.service.BookAdminService;
...
public class BookAdminServiceImpl extends ServiceImpl<BookAdminMapper, Book> implements BookAdminService {
    ...
    private void fillCategoryName(BookVO bookVO) {
        Category category = categoryAdminMapper.selectById(bookVO.getCategoryId());
        if(category != null){
