...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void register(UserRegisterDTO userRegisterDTO) {
        ...
        String cofirmedPass = userRegisterDTO.getConfirmPassword();

        //1. 判断password 和 confirmedPasss是否相等
        if(!password.equals(cofirmedPass)){
    ...
    public void reviseProfile(UserProfileDTO userProfileDTO) {
        Long currentId  = UserContext.getUser().getUserId();
    ...
    public String uploadImage(MultipartFile file, String imageType) {
        ...
        try {
            ...
            String userId = UserContext.getUser().getUserId().toString();
